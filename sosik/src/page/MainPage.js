          ...
          <Link to={!member || !member.result ? "/login" : "/recdkcal"}>
            <div data-v-4b6b04e7="" className="box_responsible type_esg">
              ...
              <a
                ...
                data-tiara-layer="Area_Main_responsible"
                data-tiara-action-name="Click_Main_esg"
                className="btn_area"
              >
                <span data-v-4b6b04e7="" className="screen_out">
                  바로가기
                </span>
                <svg
                  data-v-42492cb5=""
          ...
          <Link to="/freeboard">
            <div data-v-4b6b04e7="" className="box_responsible type_green">
              ...
              <img
                data-v-a968263a=""
                data-v-4b6b04e7=""
                src="https://t1.kakaocdn.net/kakaocorp/kakaocorp/service/main/green.gif"
                className="img_responsible"
              />
              <p data-v-4b6b04e7="" className="text_responsible">
                커뮤니티
              </p>
              <a
                ...
                data-tiara-layer="Area_Main_responsible"
                data-tiara-action-name="Click_Main_activeGreen"
                className="btn_area"
              >
                <svg
                  data-v-42492cb5=""
