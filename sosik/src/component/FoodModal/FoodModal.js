        ...
        </div>
        {
          ...
          <div className={'modal-container'} ref={modalBackground} onClick={e => {
            ...
            <div className={'modal-content'}>
              <p>음식 검색</p>
              <span style={{fontSize: '14px'}}> * 모든 음식은 100g/ 100ml 기준입니다. </span>
            ...
            <table >
                ...
                <tbody>
                    <td style={{ width: '25%', textAlign: 'center' }}>사과잼파이</td>
                    ...
                    <td style={{ width: '10%', textAlign: 'center' }}>
                      <input type="text" value={inputValue} onChange={handleInputChange} placeholder="" style={{width : '50px'}}/>
                    </td>
                    <td style={{ width: '10%', textAlign: 'center' }}><FontAwesomeIcon icon={faPlus}  /></td>
                </tbody>
                ...
                <tbody>
                  ...
                  <Pagination style={{ position: 'absolute', bottom: '0', left: '50%', transform: 'translateX(-50%)' }}>
                    <Pagination.First />
                    <Pagination.Prev />
