...
import '../../../common/css/recipecss/recipewrite/writebody.css'
...
function Writebody() {
    ...
    const removeSeasoning = (id) => {
        ...
        const updatedSeasonings = seasonings.filter((seasoning) => seasoning.id !== id);
    ...
    const renderSteps = () => {
        ...
        steps.push(
            ...
            <Form.Group className="mb-3">
                ...
                <Form.Control as="textarea" rows={4} placeholder="설명을 입력해주세요" />
            </Form.Group>
            </Card>
        );
    }
        ...
        <Col xs={5}>
            <Form>
                ...
                <Form.Group className="mb-3" >
                    ...
                    <Form.Control as="textarea" rows={8} placeholder="내용을 입력해주세요"/>
                </Form.Group>
                <Form.Group className="mb-3">
                    ...
                    <Card body className="recipecard">
                        {ingredients.map((ingredient, index) => (
                            <div key={ingredient.id}>
                                <Form.Control type="text" className="wofy" placeholder="예) 돼지고기(200g)" />
                                {ingredients.length > 1 && index !== 0 && (
                                    <Button type="button" className="btn btn-secondary plusminus" onClick={() => removeIngredient(ingredient.id)}>
                                ...
                                {index === ingredients.length - 1 && (
                                    <>
                                        <Button type="button" className="btn btn-secondary plusminus" onClick={addIngredient}>
                    ...
                    <Card body className="recipecard">
                        {seasonings.map((seasoning, index) => (
                            <div key={seasoning.id}>
                                <Form.Control type="text" className="wofy" placeholder="예) 진간장 2스푼(20g)" />
                                {seasonings.length > 1 && index !== 0 && (
                                    <Button type="button" className="btn btn-secondary plusminus" onClick={() => removeSeasoning(seasoning.id)}>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-dash-lg" viewBox="0 0 16 16">
                                            <path fill-rule="evenodd" d="M2 8a.5.5 0 0 1 .5-.5h11a.5.5 0 0 1 0 1h-11A.5.5 0 0 1 2 8Z"></path>
                                        </svg>
                                    </Button>
                                ...
                                {index === seasonings.length - 1 && (
                                    <>
                                        <Button type="button" className="btn btn-secondary plusminus" onClick={addSeasoning}>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-lg" viewBox="0 0 16 16">
                                            <path fill-rule="evenodd" d="M8 2a.5.5 0 0 1 .5.5v5h5a.5.5 0 0 1 0 1h-5v5a.5.5 0 0 1-1 0v-5h-5a.5.5 0 0 1 0-1h5v-5A.5.5 0 0 1 8 2Z"></path>
                                        </svg>
                                        </Button>
            ...
            <Form.Group>
                ...
                <Button type="button" className="btn btn-secondary plusstep" onClick={addStep}>
                단계추가
                </Button>
                {stepCount > 1 && (
                    <Button type="button" className="btn btn-secondary minusstep" onClick={removeStep}>
                    단계삭제
                    </Button>
                )}
                </div>
            ...
            <div className='recipebtn' >      
            <Button variant="outline-light" className="rounded-pill writebutton" type="button">
              <strong>작성</strong>
            </Button>
            </div>
